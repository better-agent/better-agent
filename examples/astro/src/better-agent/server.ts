...
const openaiProvider = createOpenAI({
    apiKey: import.meta.env.OPENAI_API_KEY ?? "your-openai-api-key",
});

const anthropicProvider = createAnthropic({
    apiKey: import.meta.env.ANTHROPIC_API_KEY ?? "your-anthropic-api-key",
});

const xaiProvider = createXAI({
    apiKey: import.meta.env.XAI_API_KEY ?? "your-xai-api-key",
});
...
const app = betterAgent({
    ...
    baseURL: "/agents",
    secret: import.meta.env.BETTER_AGENT_SECRET ?? "your-secret-here",
});
