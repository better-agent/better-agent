---
title: Astro
description: Build Better Agent apps in Astro.
---

import { Callout } from "fumadocs-ui/components/callout";

Build a Better Agent app in Astro with a typed client, `useAgent(...)`, durable conversations, approvals, client tools, and stream recovery.
...
Create an Astro API route and forward the request to Better Agent.

```ts title="src/pages/agents/[...path].ts"
...
In Astro, the interactive chat usually lives in a hydrated island.
...
```tsx title="src/components/billing-chat.tsx"
import { useAgent } from "@better-agent/client/react";
import { client } from "../better-agent/client";
...
```tsx title="src/components/tools-chat.tsx"
import { useAgent } from "@better-agent/client/react";
import { client } from "../better-agent/client";
...
```tsx title="src/components/approvals-chat.tsx"
import { useAgent } from "@better-agent/client/react";
import { client } from "../better-agent/client";

export function ApprovalsChat() {
...
```tsx title="src/components/observability-chat.tsx"
import { useAgent } from "@better-agent/client/react";
import { client } from "../better-agent/client";

export function ObservabilityChat() {
  useAgent(client, {
    agent: "assistant",
    onResponse: (response) => {
...
```tsx title="src/components/local-state-chat.tsx"
import { useAgent } from "@better-agent/client/react";
import { client } from "../better-agent/client";

export function LocalStateChat() {
  const agent = useAgent(client, {
    agent: "assistant",
    initialMessages: [
      {
...
```tsx title="src/components/optimistic-chat.tsx"
import { useAgent } from "@better-agent/client/react";
import { client } from "../better-agent/client";
