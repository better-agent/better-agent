---
title: Remix
description: Build Better Agent apps in Remix.
---

import { Callout } from "fumadocs-ui/components/callout";

Build a Better Agent app in Remix with a typed client, `useAgent(...)`, durable conversations, approvals, client tools, and stream recovery.

## Create the app

Start with a normal Better Agent server module.

```ts title="app/better-agent/server.ts"
...
Create a Remix route module and forward the request to Better Agent from both the loader and action.

```ts title="app/routes/agents.$.ts"
...
<Callout type="info">
  Keep `baseURL` and the route path aligned. If the app uses `baseURL: "/agents"`, the route should handle requests under `/agents`.
</Callout>
...
```ts title="app/better-agent/client.ts"
...
```tsx title="app/routes/billing.tsx"
import { useAgent } from "@better-agent/client/react";
import { client } from "../better-agent/client";
...
```tsx title="app/routes/tools.tsx"
import { useAgent } from "@better-agent/client/react";
import { client } from "../better-agent/client";
...
```tsx title="app/routes/approvals.tsx"
import { useAgent } from "@better-agent/client/react";
import { client } from "../better-agent/client";
...
```tsx title="app/routes/observability.tsx"
import { useAgent } from "@better-agent/client/react";
import { client } from "../better-agent/client";
...
```tsx title="app/routes/local-state.tsx"
import { useAgent } from "@better-agent/client/react";
import { client } from "../better-agent/client";
...
```tsx title="app/routes/optimistic.tsx"
import { useAgent } from "@better-agent/client/react";
import { client } from "../better-agent/client";
