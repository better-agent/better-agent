---
title: Next.js
description: Build Better Agent apps in Next.js.
---

import { Callout } from "fumadocs-ui/components/callout";

Build a Better Agent app in Next.js App Router with a typed client, `useAgent(...)`, durable conversations, approvals, client tools, and stream recovery.
...
Create a catch-all App Router route and forward the request to Better Agent.

```ts title="src/app/agents/[...path]/route.ts"
...
```tsx title="src/app/billing/page.tsx"
"use client";
...
```tsx title="src/app/tools/page.tsx"
"use client";
...
```tsx title="src/app/approvals/page.tsx"
"use client";
...
```tsx title="src/app/observability/page.tsx"
"use client";
...
```tsx title="src/app/local-state/page.tsx"
"use client";
...
```tsx title="src/app/optimistic/page.tsx"
"use client";
